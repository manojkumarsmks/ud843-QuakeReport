...
public class QueryUtils {
    ...
    private final static String LOG = "QUERY_UTILS_LOG";
    private final static String LOCATION_SEPERATOR = " of ";
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                JSONObject jsonProperty = tempObject.getJSONObject("properties");
                double magnitude = jsonProperty.getDouble("mag");

                String url = jsonProperty.getString("url");
                String location = jsonProperty.getString("place");
                ...
                if(location.contains(LOCATION_SEPERATOR)) {
                    String[] locationSplit = location.split(LOCATION_SEPERATOR);
                    locationOffset = locationSplit[0] + LOCATION_SEPERATOR;
                ...
                String date = dateFormat.format(new Date(jsonProperty.getLong("time")));
                String time = timeFormat.format(new Date(jsonProperty.getLong("time")));

                earthquakes.add(new EarthQuake(magnitude, locationOffset, primaryLocation, date, time, url));
